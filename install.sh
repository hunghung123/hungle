...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://hc5gvpn.com/XrayR/AutoVV/4ggiare/Hc5gvpn.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://hc5gvpn.com/XrarRVIP/Hc5gvpn.zip"
    ...
    curl -o /usr/bin/XrayR -Ls https://hc5gvpn.com/XrayR/AutoVV/4ggiare/XrayR.sh
